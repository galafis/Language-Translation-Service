...
**Language Translation Service** — Professional project by Gabriel Demetrios Lafis

Total source lines: **537** across **5** files in **5** languages.
...
Total de linhas de código: **537** em **5** arquivos em **5** linguagens.
